...
| **GenerateReport** | False   | False         | **Report**, **GR**     | Switch that, when used, generates a report file with important encoding metrics pulled from the log file in a friendly reading format                    |
